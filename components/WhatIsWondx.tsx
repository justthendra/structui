...
export default function WhatIsWondx() {
  return (
    <section className="bg-white py-16 md:py-28 px-6 md:px-8 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 max-w-[1100px] mx-auto items-center">
        ...
        >
          <div className="self-stretch flex flex-col justify-start items-start gap-4">
            ...
            <div className="inline-flex items-center gap-1.5 mb-1">
              <span className="text-zinc-500 text-xs font-semibold font-geist leading-none">
                What is
              </span>
              <img
            ...
            <h2 className="self-stretch max-w-[432px] text-[#202020] text-[40px] md:text-[56px] font-extrabold font-bricolage tracking-[-2px] md:tracking-[-2.8px] leading-[1.07]">
              Where great code is built &amp; shared.
            </h2>

            <p className="self-stretch max-w-[432px] text-zinc-500 text-base font-normal font-geist leading-relaxed">
          ...
          <div className="w-full max-w-[400px] flex flex-col justify-start items-start gap-6">
            ...
            >
              <span className="text-zinc-400 text-[11px] font-bold font-geist mt-0.5">
                01
              </span>
              <div className="flex-1 flex flex-col justify-start items-start gap-1">
                ...
                <p className="text-zinc-500 text-xs md:text-[13px] font-normal font-geist leading-relaxed">
        ...
        >
          <div className="rounded-2xl overflow-hidden shadow-xl border border-neutral-200/80 hover:scale-[1.01] transition-transform duration-500 bg-white">
            <img
