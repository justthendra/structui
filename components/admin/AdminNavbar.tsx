...
export default function AdminNavbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-neutral-200/80 shadow-xs font-geist">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <Link href="/admin" className="flex items-center gap-2.5 group">
            ...
            />
            <span className="font-bricolage font-extrabold text-xl tracking-tight text-[#202020]">
              struct<span className="text-[#3D38E9]">ui</span><span className="text-[#3D38E9]">.</span>
            </span>
            <span className="bg-[#3D38E9]/10 text-[#3D38E9] border border-[#3D38E9]/20 text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
              Admin Console
            </span>
          </Link>
        ...
        {/* Right: Exit to Live Site & Admin Profile */}
        <div className="flex items-center gap-3">
          {/* Back to Live Site Button */}
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-zinc-600 hover:text-[#202020] bg-neutral-100 hover:bg-neutral-200/80 border border-neutral-200 transition-colors cursor-pointer"
          >
            <span>Live Site</span>
          ...
          {/* Admin User Chip */}
          <div className="flex items-center gap-2.5 pl-2 pr-3 py-1 bg-white rounded-full border border-neutral-200/90 shadow-xs">
            <img
            ...
            <div className="hidden sm:block leading-tight text-left">
              <p className="text-xs font-bold text-[#202020] max-w-[100px] truncate">
                @{user?.username}
              </p>
