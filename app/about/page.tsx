...
export default function AboutPage() {
  const values = [
    {
      ...
      icon: <Sparkles className="w-5 h-5 text-[#3D38E9]" />,
      badge: "Creator First",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white text-[#202020] flex flex-col justify-between font-geist selection:bg-[#3D38E9]/20 selection:text-[#3D38E9]">
      <Navbar />

      {/* Hero Header */}
      <section className="relative bg-[#F7F7F7] border-b border-neutral-200/80 pt-20 mt-16 pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-[900px] mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 mb-4 bg-white px-3.5 py-1.5 rounded-full border border-neutral-200 shadow-xs">
            <span className="text-[#3D38E9] font-bold text-xs">✨</span>
            <span className="text-zinc-600 text-xs font-semibold font-geist">
              About structui &amp; kodikas.org
            </span>
          </div>

          <h1 className="font-bricolage text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#202020] tracking-tighter leading-[1.08] max-w-2xl mb-4">
            Building the future of <br />
            <span className="text-[#3D38E9]">modular web design.</span>
          </h1>

          <p className="text-zinc-500 text-sm sm:text-base font-geist max-w-xl leading-relaxed">
      ...
      <main className="max-w-[1100px] w-full mx-auto px-6 py-16 space-y-16 flex-1">
        ...
        <div className="rounded-3xl border border-neutral-200 bg-white p-2 shadow-xs">
          <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 max-w-xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-neutral-200 rounded-full shadow-2xs">
                <span className="size-2 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-xs font-bold text-zinc-700">Powered by Kodikas Organization</span>
              </div>

              <h2 className="font-bricolage text-3xl sm:text-4xl font-extrabold text-[#202020] tracking-tight">
              ...
              <div className="flex items-center gap-3 pt-2 flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-5 py-2.5 bg-[#3D38E9] hover:bg-[#322DC8] text-white text-xs sm:text-sm font-semibold rounded-xl inline-flex items-center gap-2 transition-all shadow-xs"
                >
            ...
            <div className="w-full md:w-auto flex justify-center">
              <div className="relative p-8 bg-white rounded-3xl border border-neutral-200 shadow-md text-center flex flex-col items-center gap-3">
                <img
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400 font-medium font-geist">v1.0.0 by kodikas.org</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <div className="text-center mb-10">
            <h3 className="font-bricolage text-3xl font-extrabold text-[#202020] tracking-tight">
              Our Core Principles
            </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {values.map((v) => (
              <div
                key={v.title}
                className="rounded-3xl border border-neutral-200 bg-white p-2 shadow-xs hover:border-neutral-300 transition-colors"
              >
                <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50 p-6 flex flex-col justify-between h-full gap-4">
                  <div className="flex items-center justify-between">
                    <div className="p-3 bg-white rounded-2xl border border-neutral-200/70 shadow-2xs">
                      {v.icon}
                    </div>
                    <span className="text-[11px] font-bold px-2.5 py-1 bg-white text-zinc-700 rounded-lg border border-neutral-200">
                      {v.badge}
                    </span>
                  </div>

                  <div>
                    <h4 className="font-bricolage text-xl font-bold text-[#202020] mb-1.5">
                      {v.title}
                    </h4>
                    <p className="text-xs sm:text-sm text-zinc-500 font-geist leading-relaxed">
                      {v.desc}
                    </p>
                  </div>
                </div>
        ...
        {/* CTA Banner */}
        <div className="rounded-3xl border border-neutral-200 bg-[#111111] p-8 sm:p-12 text-white text-center flex flex-col items-center gap-5 shadow-lg">
          ...
          <div className="flex items-center gap-3 pt-2 flex-wrap justify-center">
            <Link
              href="/explore"
              className="px-6 py-3 bg-[#3D38E9] hover:bg-[#322DC8] text-white text-xs sm:text-sm font-semibold rounded-xl inline-flex items-center gap-2 transition-all shadow-xs"
            >
            ...
            <Link
              href="/register"
              className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white text-xs sm:text-sm font-semibold rounded-xl border border-white/20 transition-all"
            >
              Join as Creator
            </Link>
          </div>
